...
class maingame():
    def game_loop(self):
        ...
        while running:
            ...
            # メモリに残っているすべてのオブジェクトのリスト
            # all_objects = objgraph.by_type('dict')  # 例えば、'dict'オブジェクトを調べる

            # その中から最も参照されているオブジェクトを探し、その参照元を表示
            # objgraph.show_backrefs([all_objects[0]], max_depth=10, filename='ref_graph.png')  
